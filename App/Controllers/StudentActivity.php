...
class StudentActivity extends Controller
{
    ...
    public function datatable(Request $request)
    {
        // print_r($request);
        $student=new Student();
        echo  $student->datatable($request->input["deleted"]);
    }
    public function store(Request $request)
    {
        ...
        $student->createdBy=Session::get('USERNAME');
        $student->createdFrom=$_SERVER['REMOTE_ADDR'];
    ...
    public function update(Request $request)
    {
        ...
        $student->address=$request->input["address"];
        $student->phone=$request->input["phone"];
        $student->modifiedAt=date('Y-m-d H:i:s');
        $student->modifiedBy=Session::get('USERNAME');
        $student->modifiedFrom=$_SERVER['REMOTE_ADDR'];
    ...
    public function delete(Request $request)
    {
        ...
        $student->deletedAt=date('Y-m-d H:i:s');
        $student->deletedBy=Session::get('USERNAME');
        $student->deletedFrom=$_SERVER['REMOTE_ADDR'];
        $response=$student->update(" id IN ($id) ");
        echo $response->toJSON();
